...
class TicketController extends ApiController
{
    ...
    {
        if ($this->isAble('store', Ticket::class)) { // ('Policy method name in TicketPolicy', 'Model instance')
    ...
    {
        if ($this->isAble('delete', $ticket)) { // ('Policy method name in TicketPolicy', 'Model instance')
            $ticket->delete();
