...
class UserController extends ApiController
{
    ...
    {
        if ($this->isAble('store', User::class)) { // ('Policy method name in UserPolicy', 'Model instance')
    ...
    {
        if ($this->isAble('delete', $user)) { // ('Policy method name in UserPolicy', 'Model instance')
            $user->delete();
